...
//    console.log($resource('/api/posts/:id'))
...
app.factory('socialAccountService', function($resource){
...
app.controller('menuController',function(menuService, $scope, $rootScope, $location){
